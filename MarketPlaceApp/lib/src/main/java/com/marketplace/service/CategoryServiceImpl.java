...
public class CategoryServiceImpl implements ICategoryService {
	 ...
	 */
	@Override
	public String getCategory(String userName, String catrgory, String sortFieldName, String sortOrder)
			throws Exception {
		if (!this.dataService.getCategoryData().containsKey(catrgory)) {
		...
		if (sortFieldName != null) {
			listing = this.dataService.getCategoryData().get(catrgory).sort(sortFieldName, sortOrder);
		} else {
			listing = this.dataService.getCategoryData().get(catrgory).getProducts();
		}
